...
const HomePage = () => {
    return (
        <div>
            ...
            <p>I'm based in Los Angeles. I have a background in the arts, and I love that front-end development lets me use both sides of my brain. If you'd like to check out my github profile, you can do so <a href="https://github.com/JordanKurtzman">here.</a>
